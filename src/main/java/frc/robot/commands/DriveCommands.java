...
public class DriveCommands {
  ...
  public static Command joystickDrive(
    ...
    ProfiledPIDController snakeController = new ProfiledPIDController(
        ANGLE_KP,
        0.0,
        ANGLE_KD,
    ...
    return Commands.run(
        () -> {
          ...
          // Snake Mode Logic
          if (snakeModeSupplier.get() && isIntakingSupplier.get() && linearVelocity.getNorm() > 1e-3) {
            Rotation2d targetYaw = linearVelocity.getAngle().plus(Rotation2d.fromDegrees(180));
            omega = snakeController.calculate(drive.getRotation().getRadians(), targetYaw.getRadians());
          }
