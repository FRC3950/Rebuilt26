...
public class Robot extends LoggedRobot {
  ...
  public Robot() {
    ...
    gymSimRuntime =
        Constants.currentMode == Constants.Mode.SIM ? GymSimRuntime.start(robotContainer) : null;
  }
  ...
  public void robotPeriodic() {
    ...
    BatteryLogger.getInstance().periodicAfterScheduler();
  ...
  public void simulationInit() {
    simulationCommand = robotContainer.getSimulationCommand();
    if (simulationCommand != null) {
      CommandScheduler.getInstance().schedule(simulationCommand);
    }
  }
